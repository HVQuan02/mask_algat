...
from datasets import FCVID, miniKINETICS, ACTNET, YLIMED
...
parser.add_argument('--dataset_root', default='/home/dimidask/Projects/ActivityNet', help='dataset root directory')
...
def main():
    ...
    if args.dataset == 'fcvid':
        ...
        acc = top_k_accuracy_score(dataset.labels, scores, k=1)
